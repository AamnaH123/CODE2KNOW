...
player = 1         # to initialise the first player
total_moves =0 #to count the total move, it should not exceed the value of 9.If it exceeds 9,game will end.
end_check= 0


def check(): #checking the moves of player 1 and player 2

       # for horizonatal(start)
